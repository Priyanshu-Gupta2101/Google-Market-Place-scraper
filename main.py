...
class GoogleMapScraper:
    ...
    def save_data(self, data):
        header = ['id', 'company_name', 'address', 'category', 'phone', 'website']
...
urls = [
    "https://www.google.com/maps/search/restaurant+around+me/@19.0255255,73.0892526,14z/data=!3m1!4b1?entry=ttu"
]
